...
\begin{lstlisting}
wget https://raw.githubusercontent.com/varenya27/EE3900/master/Assignment-1/codes/2.py
\end{lstlisting}
\begin{figure}[!ht]
\begin{center}
...
\begin{lstlisting}
wget https://raw.githubusercontent.com/varenya27/EE3900/master/Assignment-1/codes/3.py
\end{lstlisting}
\begin{align}
H(e^{\j\omega}) &= \frac{1 + e^{-2\j\omega}}{1 + \frac{1}{2}z^{-\j\omega}}
\end{align}
Let the function have a periodicity $T$
\begin{align}
    \implies H(e^{\j(\omega+T)}) &= H(e^{\j\omega})\\
    \implies \frac{1 + e^{-2\j(\omega+T)}}{1 + \frac{1}{2}e^{-\j(\omega+T)}} &= \frac{1 + e^{-2\j\omega}}{1 + \frac{1}{2}e^{-\j\omega}}
    % \implies \frac{1+cos(2(\omega+T)-\j sin(2(\omega+T)}{1+\frac{1}{2}(cos((\omega+T)-\j sin((\omega+T))}&= \frac{1+cos(2(\omega)-\j sin(2(\omega)}{1+\frac{1}{2}(cos((\omega)-\j sin((\omega))}
\end{align}
$e^{-2\j(\omega+T)}$ and $e^{-\j(\omega+T)}$ can both be written in terms of sines and cosines. $e^{-2\j(\omega+T)}$ will repeat for every $T=n\pi$ whereas $e^{-\j(\omega+T)}$ will repeat for all $T=2n\pi$.
Period $T= 2\pi$
\begin{figure}[!ht]
\centering
...
\label{fig:hn}
\end{figure}
The plot is both bounded and convergent.
...
%
\begin{lstlisting}
wget https://raw.githubusercontent.com/varenya27/EE3900/master/Assignment-1/codes/5.py
\end{lstlisting}
\begin{figure}[!ht]
\centering
